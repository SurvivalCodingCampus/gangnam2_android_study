...
import com.misterjerry.gangnam2kiandroidstudy.presentation.component.MediumButton
...
@Composable
fun SplashScreen(onStartButtonClick: () -> Unit,isEnable: Boolean ) {
    Box(
        modifier = Modifier
            .fillMaxSize()
    ) {
        ...
        Column(
            ...
            Box(modifier = Modifier.padding(horizontal = 16.dp)) {
                MediumButton("Start Cooking", onClick = { onStartButtonClick() },isEnable)
